 ...
 *   3. Import and run: import('./shared/orientation-model.test.js')
 *
 * To run via Node.js:
 *   node --experimental-vm-modules src/web/GAMBIT/shared/orientation-model.test.js
 *
 ...
 */
function testNeutralPosition() {
    console.log('\n=== Test: Neutral Position ===');
    const sensor = { roll: 0, pitch: 0, yaw: 0 };
 ...
 */
function testForwardTilt() {
    console.log('\n=== Test: Forward Tilt (30°) ===');
    const sensor = { roll: 0, pitch: -30, yaw: 0 };
    const hand = mapSensorToHand(sensor);
 ...
 */
function testLeftTilt() {
    console.log('\n=== Test: Left Tilt (30°) ===');
    const sensor = { roll: -30, pitch: 0, yaw: 0 };
    const hand = mapSensorToHand(sensor);
 ...
 */
function testClockwiseRotation() {
    console.log('\n=== Test: Clockwise Rotation (45°) ===');
    const sensor = { roll: 0, pitch: 0, yaw: 45 };
    const hand = mapSensorToHand(sensor);
 ...
 */
function testThreeJSFormat() {
    console.log('\n=== Test: Three.js Format ===');
    const sensor = { roll: 30, pitch: -45, yaw: 60 };
 ...
 */
function testDescribeExpectedPose() {
 ...
 */
function testValidationCases() {
    console.log('\n=== Test: Validation Cases ===');
    const results = validateMapping(mapSensorToHand);
