 ...
 * @returns {Promise<string|null>} SHA of existing file or null
 */
async function getFileSha(options) {
 ...
 */
export async function uploadToGitHubLFS(options) {
    ...
    try {
        ...
        throw new Error(`LFS Batch API request failed: ${e.message}`);
    }
 ...
 * @param {Object} options - Same as uploadToGitHubLFS
 * @returns {Promise<Object>} Upload result
 */
export async function uploadToGitHubContents(options) {
